    ...
    return (
      <div className="the-fixed-background-root-div">
        ...
        <div className="set-div-to-full-screen">
          <div>
            {/* <img src={m} alt=""/> */}
            <h1 className="heading">VyaaPaar </h1>
        ...
        <div>
          ...
          <div className="clip-path-no-up background-choose">
            <div className="text-in-special">
              <div>
                <a className="links-homie" href="https://github.com/me-abhinav-1001/VyaaPaar">
                  <h1 className="fadeInLeft heading">
                    me-abhinav-1001/<br />VyaaPaar<i class="ri-bookmark-line"> </i>
                  </h1>
                </a>
                <h4 className="heading">
